...
## TODO:
- [X] [Create a download CSV file button](http://stackoverflow.com/questions/11620698/how-to-trigger-a-file-download-when-clicking-an-html-button-or-javascript) (QAZI).
- [X] Create a input field for recurring user input for destinations (TENZIN).
- [ ] Create a slider input field for recurring user input for destinations (TENZIN).
